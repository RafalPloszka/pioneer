...
export type ElectedCouncilsFieldsFragment = { __typename: 'ElectedCouncil', id: string, electedAtBlock: number, councilMembers: Array<{ __typename: 'CouncilMember', id: string, unpaidReward: any, stake: any, member: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, handle: string, isVerified: boolean, isFoundingMember: boolean, inviteCount: number, createdAt: any, councilMembers: Array<{ __typename: 'CouncilMember' }>, metadata: { __typename: 'MemberMetadata', name?: string | null | undefined, about?: string | null | undefined }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }> } }> };
...
export type GetElectedCouncilsQuery = { __typename: 'Query', electedCouncils: Array<{ __typename: 'ElectedCouncil', id: string, electedAtBlock: number, councilMembers: Array<{ __typename: 'CouncilMember', id: string, unpaidReward: any, stake: any, member: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, handle: string, isVerified: boolean, isFoundingMember: boolean, inviteCount: number, createdAt: any, councilMembers: Array<{ __typename: 'CouncilMember' }>, metadata: { __typename: 'MemberMetadata', name?: string | null | undefined, about?: string | null | undefined }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }> } }> }> };
...
export type GetPastElectionQuery = { __typename: 'Query', electionRoundByUniqueInput?: { __typename: 'ElectionRound', id: string, cycleId: number, updatedAt?: any | null | undefined, candidates: Array<{ __typename: 'Candidate', stake: any }>, castVotes: Array<{ __typename: 'CastVote', voteForId?: string | null | undefined }> } | null | undefined };
...
export type GetElectionVotesQuery = { __typename: 'Query', castVotes: Array<{ __typename: 'CastVote', stake: any, stakeLocked: boolean, castBy: string, voteFor?: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, handle: string, isVerified: boolean, isFoundingMember: boolean, inviteCount: number, createdAt: any, metadata: { __typename: 'MemberMetadata', name?: string | null | undefined, about?: string | null | undefined }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }> } | null | undefined }> };
 ...
 * });
 */
export function useGetElectionVotesQuery(baseOptions?: Apollo.QueryHookOptions<GetElectionVotesQuery, GetElectionVotesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetElectionVotesQuery, GetElectionVotesQueryVariables>(GetElectionVotesDocument, options);
      }
export function useGetElectionVotesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetElectionVotesQuery, GetElectionVotesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
